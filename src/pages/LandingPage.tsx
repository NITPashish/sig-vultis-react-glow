    ...
    <div className="min-h-screen bg-[#020817] text-white font-['Inter']">
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="text-center md:text-left">
                <div 
                  className="inline-flex items-center gap-2 px-4 py-2 bg-purple-600/20 rounded-full backdrop-blur-sm"
                  style={{
                ...
                >
                  ...
                  <p className="text-lg font-semibold">
                    Vultisig Airdrop is <span className="text-purple-400 animate-pulse">LIVE!</span>
                  </p>
                </div>
                <p className="text-sm text-gray-300 mt-2 max-w-md animate-fade-in">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link
                  to="/airdrop"
                  className="group relative px-6 py-2 bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg overflow-hidden hover:scale-105 transition-all duration-300"
                >
        ...
        <div className="container mx-auto px-4 z-10 py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/download"
                className="px-8 py-4 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 rounded-lg text-lg font-semibold transition-all"
              >
                Download Now
              </Link>
              <Link
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 items-center">
            ...
            <div className="text-center">
              <div className="text-4xl font-bold text-blue-400">$500M+</div>
      ...
      <section id="problems" className="py-20 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 bg-white/5 rounded-2xl backdrop-blur-sm border border-white/10 hover:border-purple-500/50 transition-colors relative">
              <img src={robot1} alt="Robot" className="absolute -top-12 right-4 w-24 h-24" />
              <h3 className="text-xl font-semibold mb-4 text-purple-400">Single-signature wallets are dangerous</h3>
            ...
            <div className="p-8 bg-white/5 rounded-2xl backdrop-blur-sm border border-white/10 hover:border-purple-500/50 transition-colors relative">
              <img src={robot2} alt="Robot" className="absolute -top-12 right-4 w-24 h-24" />
              <h3 className="text-xl font-semibold mb-4 text-purple-400">Hardware wallets are clunky</h3>
              <p className="text-gray-400">
            ...
            <div className="p-8 bg-white/5 rounded-2xl backdrop-blur-sm border border-white/10 hover:border-purple-500/50 transition-colors relative">
              <img src={robot3} alt="Robot" className="absolute -top-12 right-4 w-24 h-24" />
              <h3 className="text-xl font-semibold mb-4 text-purple-400">Multi-signature wallets are painful</h3>
              <p className="text-gray-400">
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="spotlight-card p-8 bg-white/5 rounded-2xl backdrop-blur-sm border border-white/10 hover:border-purple-500/50 transition-all group">
              <h3 className="text-xl font-semibold mb-4 group-hover:text-purple-400 transition-colors">Threshold Signatures</h3>
            ...
            <div className="spotlight-card p-8 bg-white/5 rounded-2xl backdrop-blur-sm border border-white/10 hover:border-purple-500/50 transition-all group">
              <h3 className="text-xl font-semibold mb-4 group-hover:text-purple-400 transition-colors">Familiar Hardware</h3>
              <p className="text-gray-400">Use your phone, laptop, or tablet—fast, secure, and hassle-free. No special devices needed.</p>
            </div>
            <div className="spotlight-card p-8 bg-white/5 rounded-2xl backdrop-blur-sm border border-white/10 hover:border-purple-500/50 transition-all group">
              <h3 className="text-xl font-semibold mb-4 group-hover:text-purple-400 transition-colors">Vault Shares</h3>
            ...
            <div className="spotlight-card p-8 bg-white/5 rounded-2xl backdrop-blur-sm border border-white/10 hover:border-purple-500/50 transition-all group">
              <h3 className="text-xl font-semibold mb-4 group-hover:text-purple-400 transition-colors">Rich UI</h3>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-8">
                <div>
                  <h3 className="text-1xl font-semibold mb-2 font-['Clash Display']">Vault Generation</h3>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 h-[600px] flex flex-col justify-center">
              {features.map((feature, index) => (
                ...
                >
                  <h3 className="text-2xl font-semibold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-blue-400">
                    {feature.title}
                  </h3>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="spotlight-card p-8 bg-white/5 rounded-2xl backdrop-blur-sm border border-white/10 hover:border-purple-500/50 transition-all">
              <h3 className="text-xl font-semibold mb-4 text-purple-400">Crypto Natives</h3>
              <p className="text-gray-400">
                Swap, borrow, save, or spend in one wallet with institutional-grade security. You never need a second wallet again.
              </p>
            </div>
            <div className="spotlight-card p-8 bg-white/5 rounded-2xl backdrop-blur-sm border border-white/10 hover:border-purple-500/50 transition-all">
              <h3 className="text-xl font-semibold mb-4 text-purple-400">Whales</h3>
              <p className="text-gray-400">
            ...
            <div className="spotlight-card p-8 bg-white/5 rounded-2xl backdrop-blur-sm border border-white/10 hover:border-purple-500/50 transition-all">
              <h3 className="text-xl font-semibold mb-4 text-purple-400">Funds</h3>
              <p className="text-gray-400">
            ...
            <div className="spotlight-card p-8 bg-white/5 rounded-2xl backdrop-blur-sm border border-white/10 hover:border-purple-500/50 transition-all">
              <h3 className="text-xl font-semibold mb-4 text-purple-400">Treasuries</h3>
              <p className="text-gray-400">
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="cta-glow max-w-4xl mx-auto bg-[#0A0F1F]/40 backdrop-blur-xl rounded-2xl p-12">
            <div className="text-center space-y-8">
              <h2 className="text-4xl md:text-5xl font-['Clash Display'] font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-blue-400">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center pt-4">
                <Link
                  to="/download"
                  className="group relative px-8 py-4 bg-gradient-to-r from-purple-600 to-blue-600 rounded-xl text-lg font-semibold overflow-hidden transition-all duration-300 hover:scale-105"
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-purple-400 to-blue-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
