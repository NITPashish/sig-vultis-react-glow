        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <a href="/" className="text-2xl font-bold flex items-center mb-4">
              <span className="font-display font-extrabold text-white">VULTISIG</span>
            </a>
            <p className="text-gray-400 mb-6">
              Secure your digital assets with multi-signature technology. Experience the future of financial security.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Multi-Signature Wallets</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Smart Contract Creation</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Digital Asset Management</a></li>
